...
public class AccountService {
    ...
    public List<Account> getAllAccounts(int uuid) {
        // Get All users
        return null;
    }
...
//        return (int) abs(((random.nextInt() % 900000000L) + 1000000000L));
    ...
    public void addExistingTransaction(Account account, int transactionID, int receiverID, double amount, Date timestamp, String memo) {
